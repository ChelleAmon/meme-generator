import saveCaption from "../../caption/services/save-caption.js"
    ...
    export function updateMemeCanvas() {
        ...
        if(!image) return;
            ...
            ctx.fillText(topTextInput.value, w/2, yOffSet);
            ctx.strokeText(topTextInput.value, w/2, yOffSet);

            // adding the bottom text
            ctx.textBaseline = 'Bottom';
            ctx.fillText(botTextInput.value, w/2, h - yOffSet);
            ctx.strokeText(botTextInput.value, w/2, h - yOffSet);
